...
function popupsavetraveller() { 
	$(".popup-savetraveller").each(function () { 
		var $this = $(this),
			popupBg = $this.find(".popup-bg"), 
			popupClose = $this.find(".popup-close");
		$(".popup-btn-savetraveller").add(popupBg).add(popupClose).on("click", function (e) {
			e.preventDefault();  
			$(".popup-savetraveller").toggleClass("viewed");
			$(".popup-preview-overlay-2").toggleClass("viewed");
			$("html").toggleClass("scroll-lock");
		});
	}); 
