...
class CurrencyController extends Controller
{
	 ...
	 public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			if($isexist){
				return Redirect::to('/settings/currencies/')->with('error', 'currency is already exist');
			}
			...
			{ 
				return Redirect::to('/settings/currencies/')->with('success', 'location added Successfully');
			} 				
		}	 
	} 
	...
	//check authorization start	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/settings/currencies')->with('success', 'Currency Edited Successfully');
			}				
		}
		else
		{	 
			if(isset($id) && !empty($id)) 
			{
				...
				{
					return Redirect::to('/settings/currencies')->with('error', 'Currency Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/settings/currencies')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	} 
