...
class McqQuestionController extends Controller
{
	...
	public function addMcqQuestion(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_questions')->with('success', 'MCQ Question'.Config::get('constants.added'));	
			}	
		}
	...
	public function editMcqQuestion(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_questions')->with('success', 'MCQ Question'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/mcq_questions')->with('error', 'MCQ Question'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/mcq_questions')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
