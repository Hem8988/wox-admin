...
// Route::post('/visa/store', 'VisaController@store')->name('visa.store');	 
...
// Route::get('/cabs', 'CabController@index')->name('cab.index');	 
...
// Route::get('/privacy-policy', 'PrivacyPolicyController@index')->name('privacypolicy.index');	  
// Route::get('/terms-and-conditions', 'TermsConditionsController@index')->name('termsconditions.index');	  
// Route::get('/affiliate-partner', 'AffiliatePartnerController@index')->name('affiliatepartner.index'); 
// Route::get('/become-an-affiliate', 'AsAffiliateController@index')->name('asaffiliate.index'); 

// Route::get('booking-confirmation','HomeController@bkConfiration')->name('booking.confirmation');
// Route::get('booking-error','HomeController@bkError')->name('booking.error');
// Route::get('booking-success','HomeController@bkSuccess')->name('booking.success');

// Route::get('hotelLists','HotelController@hotelListsing')->name('hotel.listing');
// Route::get('hotel-bookings','HotelController@hotelBooking')->name('hotel.bookings');
// Route::get('hotel-details','HotelController@hotelDetails')->name('hotel.details');
...
// Route::get('/Flight/search', 'FlightsController@flightSearch')->name('flightSearch');
// Route::get('/FlightList/ajax', 'FlightsController@flightListajax')->name('flightListajax');
// Route::get('/FlightList/details/', 'FlightsController@flightDetails')->name('flightDetails');
// Route::get('/FlightBooking','FlightsController@flightBooking')->name('FlightBooking');
// Route::post('/Flight/Booking','FlightsController@bookingFlight')->name('flightbooking');

// Route::get('/Flight/Review','FlightsController@flightReview')->name('flightReview');
// Route::get('Booking/Confirm','FlightsController@bookingConfirm')->name('bookingConfirm');
// Route::get('Booking/Success','FlightsController@successBooking')->name('booking.success');
