...
class UsertypeController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/usertype')->with('success', 'User Type added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/usertype')->with('success', 'User Type Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/usertype')->with('error', 'User Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/usertype')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
