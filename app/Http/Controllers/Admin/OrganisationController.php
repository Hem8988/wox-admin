...
class OrganisationController extends Controller
{
	...
	public function addOrganisation(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/organisations')->with('success', 'Organisation'.Config::get('constants.added'));
			}
		}
	...
	public function editOrganisation(Request $request, $id = NULL)
	{
		...
		{	
			...
			{
				return Redirect::to('/organisations')->with('success', 'Organisation'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/organisations')->with('error', 'Organisation'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/organisations')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
