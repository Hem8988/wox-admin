...
class ManageexclusionController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/exclusion')->with('success', 'Exclusion added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/exclusion')->with('success', 'Exclusion Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/exclusion')->with('error', 'Exclusion Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/exclusion')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
