...
$obj->description	=	@$requestData['description'];			
			...
			{
				return Redirect::to('/locations')->with('success', 'location Edited Successfully');
			}				
		}
		else
		{	 
			if(isset($id) && !empty($id)) 
			{
				...
				{
					return Redirect::to('/locations')->with('error', 'location Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/locations')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	} 
