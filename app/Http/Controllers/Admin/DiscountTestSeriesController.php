...
class DiscountTestSeriesController extends Controller
{
	...
	public function addTestSeriesDiscount(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/test_series_discounts')->with('success', 'Test Series Discount'.Config::get('constants.added'));
			}				
		}
	...
	public function editTestSeriesDiscount(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/test_series_discounts')->with('success', 'Test Series Discount'.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/test_series_discounts')->with('error', 'Test Series Discount'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/test_series_discounts')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
