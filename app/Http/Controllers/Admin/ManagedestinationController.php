...
class ManagedestinationController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		//	$obj->slug	=	$this->createSlug(Auth::user()->id,'destinations',@$requestData['dest_name']);
			...
			{
				return Redirect::to('/destination')->with('success', 'Destination added Successfully');
			}				
		}	
	...
	//check authorization start	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/destination')->with('success', 'Destination Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id)) 
			{
				...
				{
					return Redirect::to('/destination')->with('error', 'Destination Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/destination')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
