...
Route::get('/FlightList/Review', 'Agent\FlightController@flightReview');
Route::get('/FlightList/details/', 'Agent\FlightController@flightDetails')->name('flightDetails');
Route::get('/FlightBooking','Agent\FlightController@flightBooking')->name('FlightBooking');
Route::post('/Flight/Booking','Agent\FlightController@bookingFlight')->name('flightbooking');
