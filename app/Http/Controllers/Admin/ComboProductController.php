	...
	public function addComboProduct(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			else
			{
				...
				return Redirect::to('/combo_products')->with('success', 'Combo Product'.Config::get('constants.added'));
			}
		}
	...
	public function editComboProduct(Request $request, $id = NULL)
	{
		...
		{	
			...
			else
			{
				...
				return Redirect::to('/combo_products')->with('success', 'Combo Product'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/combo_products')->with('error', 'Combo Product'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/combo_products')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
