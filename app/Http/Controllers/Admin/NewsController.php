...
class NewsController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/news')->with('success', 'News added Successfully');
			}
		}			
	}
	...
	{	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/news')->with('success', 'News '.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/news')->with('error', 'News '.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/news')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
