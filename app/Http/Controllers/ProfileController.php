...
class ProfileController extends Controller
{
	...
	/*public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/inclusion')->with('success', 'Inclusion added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/inclusion')->with('success', 'Inclusion Edited Successfully');
			}				
		} 
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/inclusion')->with('error', 'Inclusion Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/inclusion')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	} */
