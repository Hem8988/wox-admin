...
class FreeDownloadController extends Controller
{
	...
	public function addFreeDownload(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/free_downloads')->with('success', 'Free Download '.Config::get('constants.added'));	
			}	
		}
	...
	public function editFreeDownload(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/free_downloads')->with('success', 'Free Download'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/free_downloads')->with('error', 'Free Download'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/free_downloads')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
