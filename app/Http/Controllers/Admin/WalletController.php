	...
	public function store(Request $request){
		...
		$saved				=	$wallethistory->save();
			...
			else
			{
				...
				return Redirect::to('/wallet/crdr')->with('success', 'Wallet Successfully');
			}
	}
		...
		if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/wallet')->with('error', 'Wallet Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/wallet')->with('error', Config::get('constants.unauthorized'));
			}			
	} 
