...
class StaffController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/staff')->with('success', 'User added Successfully');
			}				
		}	
	...
	public function edit(Request $request, $id = NULL)
	{
		...
		/* Profile Image Upload Function End */
			...
			{
				return Redirect::to('/staff')->with('success', 'User Edited Successfully');
			}				
		}
		...
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/staff')->with('error', 'User Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/staff')->with('error', Config::get('constants.unauthorized'));
			}		
		}	
