...
class ModeProductController extends Controller
{
	...
	public function addModeProduct(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mode_products')->with('success', 'Mode of Product'.Config::get('constants.added'));
			}				
		}
	...
	{	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mode_products')->with('success', 'Mode of Product'.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/mode_products')->with('error', 'Mode of Product'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/mode_products')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
