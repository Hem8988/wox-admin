...
class UserroleController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/userrole')->with('success', 'User Role added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/userrole')->with('success', 'User Role Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/userrole')->with('error', 'User Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/userrole')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
