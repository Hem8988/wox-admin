...
class ManageaddonController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/addons')->with('success', 'Addon added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/addons')->with('success', 'Addon Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/addons')->with('error', 'Addon Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/addons')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
