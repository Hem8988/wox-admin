...
class ManageamenitiesController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		//check authorization end
			...
			{
				return Redirect::to('/amenities')->with('success', 'Amenities added Successfully');
			}				
		}	
	...
	{			
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/amenities')->with('success', 'Amenities Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/amenities')->with('error', 'Amenities Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/amenities')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
