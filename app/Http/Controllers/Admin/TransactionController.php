...
class TransactionController extends Controller
{
	...
	public function viewTestSeriesTransaction(Request $request, $id)
	{
		...
		if(isset($id) && !empty($id))
		{
			...
			{
				return Redirect::to('/test_series_transactions')->with('error', 'Transaction Id does not exist.');
			}
		}
		else
		{
			return Redirect::to('/test_series_transactions')->with('error', Config::get('constants.unauthorized'));
		}
	}
	...
	{	
		...
		if(isset($id) && !empty($id))
		{
			...
			{
				return Redirect::to('/students')->with('error', 'Student Id does not exist.');
			}
		}
		else
		{
			return Redirect::to('/students')->with('error', Config::get('constants.unauthorized'));
		}
	}
	...
	public function viewProductTransaction(Request $request, $id)
	{
		...
		if(isset($id) && !empty($id))
		{
			...
			{
				return Redirect::to('/product_transactions')->with('error', 'Transaction'.Config::get('constants.not_exist'));
			}
		}
		else
		{
			return Redirect::to('/product_transactions')->with('error', Config::get('constants.unauthorized'));
		}
	}
	...
	public function closeSession(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/test_series_transactions')->with('success', 'Test Series Session has been expired, now you can continue with new Test Series session.');
			}				
		}
	}
}
