...
class ProfessorController extends Controller
{
	...
	public function addProfessor(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/professors')->with('success', 'Professor'.Config::get('constants.added'));
			}
		}
	...
	public function editProfessor(Request $request, $id = NULL)
	{
		...
		{	
			...
			{
				return Redirect::to('/professors')->with('success', 'Professor'.Config::get('constants.edited'));
			}
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/professors')->with('error', 'Professor'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/professors')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
