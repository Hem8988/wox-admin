...
class OrderController extends Controller
{
	...
	public function viewOrderDetails(Request $request, $id)
	{
		if(isset($id) && !empty($id))
		{
			...
			{
				return Redirect::to('/orders')->with('error', 'Order does not exist.');
			}
		}
		else
		{
			return Redirect::to('/orders')->with('error', Config::get('constants.unauthorized'));
		}
	}
	...
	public function dispatchRequest(Request $request)
	{
		if ($request->isMethod('post')) 
		{
			...
			return Redirect::to('/view_order_details/'.$this->encodeString($requestData['id']))->with('success', 'Dispatched Order successfully.');			
		}
		else
		{
