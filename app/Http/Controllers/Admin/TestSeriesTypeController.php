...
class TestSeriesTypeController extends Controller
{
	...
	public function addTestSeriesType(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/test_series_types')->with('success', 'Test Series Type'.Config::get('constants.added'));
			}				
		}
	...
	public function editTestSeriesType(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/test_series_types')->with('success', 'Test Series Type'.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/test_series_types')->with('error', 'Test Series Type'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/test_series_types')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}	
}
