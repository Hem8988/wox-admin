...
class CmsPageController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/cms_pages')->with('success', 'Page added Successfully');
			}
		}			
	}
	...
	{	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/cms_pages')->with('success', 'CMS Page'.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/cms_pages')->with('error', 'CMS Page'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/cms_pages')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
