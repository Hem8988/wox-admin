...
class TopinclusionController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/top-inclusion')->with('success', 'Topinclusion Added Successfully');
			}				
		}	
	...
	{			
		...
		/* Destination Image Upload Function End */ 
			...
			{
				return Redirect::to('/top-inclusion')->with('success', 'Topinclusion Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/top-inclusion')->with('error', 'Topinclusion Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/top-inclusion')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
