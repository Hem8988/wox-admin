			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
                       <form  enctype="multipart/form-data" method="post" action="{{ url('admin/site_information/edit') }}" novalidate>
					  {{-- {{ Form::open(array('url' => 'admin/site_information/edit', 'name'=>"", 'autocomplete'=>'off', "enctype"=>"multipart/form-data",'novalidate')) }} --}}
						 @csrf
