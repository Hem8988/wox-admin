...
class GalleryController extends Controller
{
	...
	{			
		...
		/* Gallery Image Upload Function End */ 
			...
			{
				return Redirect::to('/gallery')->with('success', 'Gallery Edited Successfully');
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/gallery')->with('error', 'Gallery Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/gallery')->with('error', Config::get('constants.unauthorized'));
			}		 
		}				
	}
