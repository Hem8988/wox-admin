...
class CouponController extends Controller
{
	 ...
	 public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
		  ...
		  $requestData 		= 	$request->all();
			...
			{ 
				return Redirect::to('/coupon-code')->with('success', 'Coupon added Successfully');
			} 				
		}	 
	} 
	...
	//check authorization start	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/coupon-code')->with('success', 'Contact Edited Successfully');
			}				
		}
		else
		{	 
			if(isset($id) && !empty($id)) 
			{
				...
				{
					return Redirect::to('/coupon-code')->with('error', 'Contact Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/coupon-code')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	} 
