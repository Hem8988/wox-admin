	...
	public function addVendor(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			else
			{
				...
				return Redirect::to('/vendors')->with('success', 'Vendor'.Config::get('constants.added'));
			}
		}
	...
	public function editVendor(Request $request, $id = NULL)
	{
		...
		{	
			...
			else
			{
				...
				return Redirect::to('/vendors')->with('success', 'Vendor'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/vendors')->with('error', 'Vendor'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/vendors')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
