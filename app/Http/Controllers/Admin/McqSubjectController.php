...
class McqSubjectController extends Controller
{
	...
	public function addMcqSubject(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_subjects')->with('success', 'MCQ Subject'.Config::get('constants.added'));
			}				
		}
	...
	{	
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_subjects')->with('success', 'MCQ Subject'.Config::get('constants.edited'));
			}				
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/mcq_subjects')->with('error', 'MCQ Subject'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/mcq_subjects')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
