...
class BankAccountController extends Controller
{
	 ...
	 public function store(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{ 
				return Redirect::to('/settings/bank-accounts/')->with('success', 'Bank Account added Successfully');
			} 				
		}	 
	}
	...
	//check authorization start	
		...
		{	 
			if(isset($id) && !empty($id)) 
			{
				...
				{
					return Redirect::to('/settings/editbank')->with('error', 'Bank Account Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/settings/editbank')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
