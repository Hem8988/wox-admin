	...
	public function addProduct(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			else
			{
				...
				return Redirect::to('/products')->with('success', 'Product'.Config::get('constants.added'));
			}
		}
	...
	public function editProduct(Request $request, $id = NULL)
	{
		...
		{	
			...
			{	
				...
				return Redirect::to('/products')->with('success', 'Product'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/products')->with('error', 'Product'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/products')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
