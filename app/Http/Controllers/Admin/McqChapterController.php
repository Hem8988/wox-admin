...
class McqChapterController extends Controller
{
	...
	public function addMcqChapter(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_chapters')->with('success', 'MCQ Chapter'.Config::get('constants.added'));	
			}	
		}
	...
	public function editMcqChapter(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/mcq_chapters')->with('success', 'Chapter'.Config::get('constants.edited'));
			}		
		}
		else
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/mcq_chapters')->with('error', 'Chapter'.Config::get('constants.not_exist'));
				}	
			}
			else
			{
				return Redirect::to('/mcq_chapters')->with('error', Config::get('constants.unauthorized'));
			}		
		}				
	}
}
