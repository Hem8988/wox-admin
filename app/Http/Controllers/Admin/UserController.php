...
if ($request->has('first_name')) 
	...
	public function edit(Request $request, $id = NULL)
	{
		...
		/* Profile Image Upload Function End */
			...
			{
				return Redirect::to('/users')->with('success', 'User Edited Successfully');
			}				
		}
		...
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/users')->with('error', 'User Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/users')->with('error', Config::get('constants.unauthorized'));
			}		
		}	
	...
	public function storeclient(Request $request)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/users/clientlist')->with('success', 'Client Added Successfully');
			}				
		}	
	...
	public function editclient(Request $request, $id = NULL)
	{
		...
		/* Profile Image Upload Function End */
			...
			{
				return Redirect::to('/users/clientlist')->with('success', 'Client Edited Successfully');
			}				
		}
		...
		{	
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/users/clientlist')->with('error', 'Client Not Exist');
				}	
			}
			else
			{
				return Redirect::to('/users/clientlist')->with('error', Config::get('constants.unauthorized'));
			}		
		}	 
